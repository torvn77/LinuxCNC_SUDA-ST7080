...
net lcnc.axis-04.amp-enable       =>  hm2_5i25.0.stepgen.04.enable
net lcnc.axis-04.motor-pos-cmd    =>  hm2_5i25.0.stepgen.04.position-cmd
net lcnc.axis-04.motor-pos-fb     <=  hm2_5i25.0.stepgen.04.position-fb
