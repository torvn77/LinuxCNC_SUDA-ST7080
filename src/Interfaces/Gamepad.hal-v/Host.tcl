...
source [lindex $::HAL(GAMEPAD.HAL-V_PATCH)]/Halui.tcl
#Модуль функциональных клавиш
source [lindex $::HAL(GAMEPAD.HAL-V_PATCH)]/Functional_Buttons.tcl
#Модуль дискреных кнопок перемещения
source [lindex $::HAL(GAMEPAD.HAL-V_PATCH)]/Gamepad_digital_axis.tcl
#Модуль аналогово джойстика
source [lindex $::HAL(GAMEPAD.HAL-V_PATCH)]/Gamepad_analog_axis.tcl
