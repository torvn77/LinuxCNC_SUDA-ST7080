...
source Interface/Gamepad-devl/Halui.hal
#Модуль функциональных клавиш
source Interface/Gamepad-devl/Functional_Buttons.hal
#Модуль дискреных кнопок перемещения
source Interface/Gamepad-devl/Gamepad_digital_axis.hal
#Модуль аналогово джойстика
source Interface/Gamepad-devl/Gamepad_analog_axis.hal
