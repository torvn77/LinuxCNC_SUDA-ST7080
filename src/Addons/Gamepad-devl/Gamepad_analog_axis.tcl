...
net gamepad.analog.X-Axis_position => joyhandle.0.in
...
net  gamepad.analog_jog_vel-0 <= joyhandle.0.out

net gamepad.analog.Y-Axis_position => joyhandle.1.in
...
net  gamepad.analog_jog_vel-1 <= joyhandle.1.out

net gamepad.analog.Z-Axis_position => joyhandle.2.in
...
net  gamepad.analog_jog_vel-2 <= joyhandle.2.out

net gamepad.analog.RZ-Axis_position => joyhandle.3.in
...
net  gamepad.analog_jog_vel-3 <= joyhandle.3.out
