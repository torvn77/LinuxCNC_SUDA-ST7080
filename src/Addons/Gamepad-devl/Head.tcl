...
source Addons/Gamepad-devl/Halui.hal
#Модуль функциональных клавиш
source Addons/Gamepad-devl/Functional_Buttons.hal
#Модуль дискреных кнопок перемещения
source Addons/Gamepad-devl/Gamepad_digital_axis.hal
#Модуль аналогово джойстика
source Addons/Gamepad-devl/Gamepad_analog_axis.hal
