...
net gamepad.func_button_1 <= input.0.btn-joystick 
net gamepad.func_button_2 <= input.0.btn-thumb 
net gamepad.func_button_3 <= input.0.btn-thumb2
net gamepad.func_button_4 <= input.0.btn-top 
net gamepad.func_button_5 <= input.0.btn-top2
#net gamepad.func_button_6 <= input.0.btn-pinkie
net gamepad.func_button_7 <= input.0.btn-base 
#net gamepad.func_button_8 <= input.0.btn-base2 
net gamepad.func_button_9 <= input.0.btn-base3 
net gamepad.func_button_10 <= input.0.btn-base4
net gamepad.func_button_11 <= input.0.btn-base5
net gamepad.func_button_12 <= input.0.btn-base6 
