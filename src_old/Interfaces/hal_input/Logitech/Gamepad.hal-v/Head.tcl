...
setp mux4.0.in2 $::TRAJ(MAX_VELOCITY)
...
source Modules/Gamepad.hal-v/Halui.hal
#Модуль функциональных клавиш
source Modules/Gamepad.hal-v/Functional_Buttons.hal
#Модуль дискреных кнопок перемещения
source Modules/Gamepad.hal-v/Gamepad_digital_axis.hal
#Модуль аналогово джойстика
source Modules/Gamepad.hal-v/Gamepad_analog_axis.hal
